  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-base font-semibold text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-input border-primary bg-background shadow-sm text-primary hover:bg-primary hover:text-background',
        secondary:
      ...
      size: {
        ...
        md: 'h-12 px-4 py-2',
        lg: 'h-14 px-8 uppercase text-sm tracking-[2px]',
        icon: 'h-9 w-9',
      },
    },
    defaultVariants: {
